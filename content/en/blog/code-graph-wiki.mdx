---
title: "Is Your LLM Knowledge Base Getting Messier with Every Update? Use NeuG to Define Concept Boundaries and Pinpoint What Needs Updating"
description: "Use NeuG, Leiden community detection, PageRank, and Cypher to build a coherent code wiki and update only the concepts affected by code changes."
date: "2026-08-03"
author: "NeuG Team"
category: "ecosystem"
tags:
...
- GDS extension docs: [/docs/extensions/load_gds/](/docs/extensions/load_gds/)
- Companion tutorial (step-by-step reproduction of this post's wiki build & update): [/docs/tutorials/code-graph-wiki-pipeline/](/docs/tutorials/code-graph-wiki-pipeline/)
